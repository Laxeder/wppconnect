...
- [wppconnect@1.24.0](https://github.com/wppconnect-team/wppconnect) - API para se conectar ao WhatsApp

## 📄 Licença

Este projeto está sob a licença MIT - veja o arquivo [LICENSE](https://github.com/Laxeder/wppconnect/blob/main/LICENSE) para mais detalhes.
